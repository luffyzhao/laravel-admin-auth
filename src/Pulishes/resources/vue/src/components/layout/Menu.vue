<template>
    <div :style="styles" v-resize="handleResize">
...
export default {
    ...
    data() {
        return {
            ...
            styles: {"flex": 1, "overflowY": "auto", "height": "100px"}
        }
    },
    computed: {
        active() {
    ...
    methods: {
        ...
        handleResize() {
            this.styles = {"flex": 1, "overflowY": "auto", "height": (window.document.body.clientHeight - 92) + 'px'};
        }
    }
}
</script>
